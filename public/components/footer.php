...
<footer id="footer" class="footer"<?php echo $dataAttr; ?><?php echo $hasCustomLogo ? ' style="--logo-url: url(\'' . htmlspecialchars($logoUrl) . '\')"' : ''; ?>>
  <div class="footer-main">
    ...
    <div class="footer-links">
      <ul>
        <li>Navigim</li>
        <li><a href="<?= $appPath('public/') ?>">Kreu</a></li>
        <li><a href="<?= $appPath('views/events.php') ?>">Evente</a></li>
        <li><a href="<?= $appPath('views/help_requests.php') ?>">Kërkesat</a></li>
        <li><a href="<?= $appPath('views/map.php') ?>">Harta</a></li></ul>
      <ul>
        <li>Legal</li>
        <li><a href="<?= $appPath('views/privacy.php') ?>">Politika e Privatësisë</a></li>
        <li><a href="<?= $appPath('views/terms.php') ?>">Rregullat e Përdorimit</a></li>
        <li><a href="<?= htmlspecialchars($contactPage) ?>">Kontakto</a></li>
      </ul>
      <ul>
        <li>Kontakt</li>
        <li><a href="<?= htmlspecialchars($contactPage) ?>">Faqja e kontaktit</a></li>
        <li><a href="<?= $appPath('views/become_organizer.php') ?>">Apliko si organizatë</a></li>
  ...
  <div class="footer-copy">
    <div class="footer-partners">
      <div class="footer-partners__logos">
        <img src="<?= $appPath('public/assets/images/bashkia.png') ?>?v=<?= @filemtime(__DIR__ . '/../assets/images/bashkia.png') ?: time() ?>"
             alt="Bashkia Tiranë"
             class="footer-partner-logo footer-partner-logo--bashkia"
             onerror="this.style.display='none'">
        <span class="footer-partners__divider"></span>
        <img src="<?= $appPath('public/assets/images/webchallenge.png') ?>?v=<?= @filemtime(__DIR__ . '/../assets/images/webchallenge.png') ?: time() ?>"
             alt="Web Challenge"
    ...
    <div style="display:flex;flex-direction:column;gap:0.5rem;font-size:0.875rem;">
      <span>Copyright &copy; <?= date('Y') ?> Bashkia Tirane. Të gjitha të drejtat të rezervuara.</span>
