...
$search = '';
$category = 0;
$statTotalEvents = $statUpcoming = $statPast = $statVullnetare = $statApplications = 0;
...
<head>
  ...
  <link rel="stylesheet" href="/TiranaSolidare/public/assets/styles/requests.css?v=20260318a">  <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />
...
<!-- ═══════════════════════════════════════════════════════════
     SINGLE EVENT DETAIL — Premium View
     ═══════════════════════════════════════════════════════════ -->
<section class="rq-detail-hero">
  ...
  <div class="rq-detail-hero__inner">
    ...
    <div class="rq-detail-hero__badges">
      <span class="rq-badge rq-badge--event">
  ...
  <div class="rq-detail-layout">
    ...
    <div class="rq-detail-main">
      <div class="rq-detail-banner">
        <img src="<?= !empty($event['banner']) ? htmlspecialchars($event['banner']) : '/TiranaSolidare/public/assets/images/default-event.svg' ?>" alt="<?= htmlspecialchars($event['titulli']) ?>" onerror="this.src='/TiranaSolidare/public/assets/images/default-event.svg'">
      </div>
      ...
      <div class="map-detail-card">
        ...
        <div id="event-detail-map" class="ts-map-display"></div>
      </div>
      <?php endif; ?>
    </div>
    ...
    <aside class="rq-detail-sidebar">
      <div class="rq-sidebar-card">
        ...
        <div class="rq-sidebar-cta">
          ...
          <?php else: ?>
            <button class="btn_primary rq-btn-full" id="apply-btn" data-event="<?= $event['id_eventi'] ?>">
...
<!-- ─── HERO ─── -->
<section class="rq-hero rq-hero--events">
  <!-- Animated SVG blobs -->
  <svg class="rq-blob rq-blob--1" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="rgba(255,255,255,0.12)" d="M44.7,-76.4C58.8,-69.2,71.8,-58.7,79.6,-45.1C87.4,-31.5,90.1,-15.7,88.5,-0.9C86.9,13.9,81.1,27.8,72.6,39.6C64.1,51.4,52.9,61.2,40.1,68.4C27.3,75.6,13.7,80.3,-0.8,81.7C-15.3,83.1,-30.5,81.3,-43.4,74.2C-56.2,67.2,-66.7,55,-73.8,41.2C-80.8,27.3,-84.4,11.7,-83.5,-3.5C-82.6,-18.7,-77.2,-33.4,-68,-45.1C-58.8,-56.8,-45.9,-65.4,-32.3,-72.8C-18.7,-80.3,-9.3,-86.5,3.2,-91.9C15.7,-97.4,30.5,-83.6,44.7,-76.4Z" transform="translate(100 100)"/></svg>
  <svg class="rq-blob rq-blob--2" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="rgba(255,215,0,0.10)" d="M39.5,-51.2C52.9,-46.3,66.8,-37.9,71.4,-25.7C76.1,-13.5,71.5,2.6,66,17.3C60.6,31.9,54.3,45.1,44,54.7C33.6,64.3,19.3,70.2,3.4,73.7C-12.6,77.2,-30.3,78.4,-42.2,70.1C-54,61.7,-60,43.8,-65.3,27.3C-70.6,10.8,-75.2,-4.2,-72.3,-18.2C-69.5,-32.1,-59.2,-45,-46.1,-50C-33.1,-55,-16.5,-52.2,-1.4,-50.2C13.7,-48.3,26.1,-56.1,39.5,-51.2Z" transform="translate(100 100)"/></svg>
  <svg class="rq-blob rq-blob--3" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="rgba(255,255,255,0.07)" d="M47.7,-73.2C60.9,-67.5,70,-53.1,76.3,-38C82.6,-22.8,86.2,-6.9,83.4,7.6C80.6,22.2,71.5,35.4,60.7,47.1C49.9,58.8,37.5,69,23.3,74.3C9.1,79.6,-6.9,80,-21.4,75.4C-35.9,70.8,-48.9,61.3,-58.8,49.1C-68.7,36.9,-75.5,22,-77.2,6.3C-78.9,-9.4,-75.5,-25.9,-67,-38.7C-58.5,-51.5,-44.9,-60.5,-31,-66.3C-17.1,-72.1,-3,-74.7,8.8,-71.1C20.5,-67.5,34.5,-78.9,47.7,-73.2Z" transform="translate(100 100)"/></svg>
